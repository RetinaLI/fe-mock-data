...
module.exports.run = function () {
  ...
  let jsonPath = program.path;
  let serverConfig, publicName, publicPath;
  appConfig();

  serverConfig = require(path.join(path.resolve('.'), jsonPath));
  publicPath = serverConfig.publicPath ? serverConfig.publicPath : 'mock-data/public'
  publicName = serverConfig.publicName ? serverConfig.publicName: 'public';
